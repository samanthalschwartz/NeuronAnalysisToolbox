...
clear all;
%NL1 files
%load('F:\zapERtrap\Raw Data\GLOBAL RELEASE\NL1\021318\cell2_merge_AshleyFile.mat')
%GluA1 files
%load('F:\zapERtrap\Raw Data\GLOBAL RELEASE\GluA1\060118\slip1_4_merge_AshleyFile.mat')
