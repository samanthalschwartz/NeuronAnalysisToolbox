...
% - save directory
load('D:\WDKennedyLabHDDBackup\Projects\Project Cry2Olig-Gephyrin\SR\190815 Gaba_Geph_RIM\results\SR mat files\GIB GabaRIM\SMLM_GIB_GABA_RIM+light_GABA647_2_SR_GIB_GABA_RIM+light_RIM568_2_SR.mat');
roiname = 'D:\WDKennedyLabHDDBackup\Projects\Project Cry2Olig-Gephyrin\SR\190815 Gaba_Geph_RIM\results\ROIs per file\GIB+light_GABA647_RIM568_2\RoiSet.zip';
savedir = 'D:\WDKennedyLabHDDBackup\Projects\Project Cry2Olig-Gephyrin\SR\190815 Gaba_Geph_RIM\results\ROIs per file\GIB+light_GABA647_RIM568_2_Stuff2';
% load in value
...
for ii = 4%1:numel(sROI)
    ...
    prec_ch1 = data.SML_data.ch1.precision(goodids_ch1);
    ...
    prec_ch2 = data.SML_data.ch2.precision(goodids_ch2);
    badids = prec_ch2>50;
    Xs_ch2(badids)=[];
    Ys_ch2(badids)=[];
    prec_ch2(badids) = [];
