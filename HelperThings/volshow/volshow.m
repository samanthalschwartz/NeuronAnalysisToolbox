% volumeshow is a flexible function for displaying multiple volume images tightly
...
function varargout = volumeshow(varargin)
% -- do not edit: MATLAB GUIDE 
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @volumeshow_OpeningFcn, ...
    'gui_OutputFcn',  @volumeshow_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before volumeshow is made visible.
function volumeshow_OpeningFcn(hObject, eventdata, handles, varargin)
...
function varargout = volumeshow_OutputFcn(hObject, eventdata, handles)
