...
ElemT Mex_Iface::getScalar(const mxArray *mxdata)
{
...
template<class ElemT> 
Mex_Iface::VecField<ElemT> 
Mex_Iface::getVecField(const mxArray *mxdata)
{
...
template<class ElemT> 
Mex_Iface::MatField<ElemT> 
Mex_Iface::getMatField(const mxArray *mxdata)
{
    if(mxdata==nullptr) mxdata=rhs[rhs_idx++];  //Default to first unhandled rhs argument
    std::ostringstream msg;
    mwSize nfields = mxGetNumberOfElements(mxdata);
...
template<class ElemT> 
Mex_Iface::CubeField<ElemT> 
Mex_Iface::getCubeField(const mxArray *mxdata)
{
    if(mxdata==nullptr) mxdata=rhs[rhs_idx++];  //Default to first unhandled rhs argument
    std::ostringstream msg;
    mwSize nfields = mxGetNumberOfElements(mxdata);
...
template<class ElemT> 
Mex_Iface::VecVector<ElemT> 
Mex_Iface::getVecVector(const mxArray *mxdata)
{
    if(mxdata==nullptr) mxdata=rhs[rhs_idx++];  //Default to first unhandled rhs argument
    std::ostringstream msg;
    mwSize nfields = mxGetNumberOfElements(mxdata);
...
template<class ElemT> 
Mex_Iface::MatVector<ElemT> 
Mex_Iface::getMatVector(const mxArray *mxdata)
{
    if(mxdata==nullptr) mxdata=rhs[rhs_idx++];  //Default to first unhandled rhs argument
    std::ostringstream msg;
    mwSize nfields = mxGetNumberOfElements(mxdata);
...
template<class ElemT> 
Mex_Iface::CubeVector<ElemT> 
Mex_Iface::getCubeVector(const mxArray *mxdata)
{
    if(mxdata==nullptr) mxdata=rhs[rhs_idx++];  //Default to first unhandled rhs argument
    std::ostringstream msg;
    mwSize nfields = mxGetNumberOfElements(mxdata);
...
template<class ElemT>
void Mex_Iface::outputStack(const arma::Cube<ElemT> &arr)
{
...
inline 
void Mex_Iface::outputBool(bool val)
{
...
template<class ElemT>
void Mex_Iface::outputSparse(const arma::SpMat<ElemT> &arr)
{
 ...
 */
template<class ElemT> 
void Mex_Iface::outputVecCellArray(const VectorVector<ElemT> &list)
{
 ...
 */
template<class ElemT> 
void Mex_Iface::outputVecCellArray(const VectorList<ElemT> &list)
{
    int nCells = list.size();
    mxArray* arr=mxCreateCellMatrix(nCells, 1);
    for(int i=0;i<nCells;i++){
...
template<class ElemT> 
void Mex_Iface::outputVecCellArray(const VecVector<ElemT> &list)
{
    int nCells = list.size();
    mxArray* arr = mxCreateCellMatrix(nCells, 1);
    for(int i=0;i<nCells;i++){
...
template<class ElemT> 
void Mex_Iface::outputVecCellArray(const VecField<ElemT> &field)
{
...
template<class ElemT> 
void Mex_Iface::outputMatCellArray(const MatVector<ElemT> &list)
{
    int nCells = list.size();
    mxArray* arr = mxCreateCellMatrix(nCells, 1);
    for(int i=0;i<nCells;i++){
...
template<class ElemT> 
void Mex_Iface::outputMatCellArray(const MatField<ElemT> &field)
{
    int nCells = static_cast<int>(field.n_elem);
    mxArray* arr = mxCreateCellMatrix(nCells, 1);
    for(int i=0;i<nCells;i++){
...
template<class ElemT> 
void Mex_Iface::outputCubeCellArray(const CubeVector<ElemT> &list)
{
    int nCells = list.size();
    mxArray* arr = mxCreateCellMatrix(nCells, 1);
    for(int i=0;i<nCells;i++){
...
template<class ElemT> 
void Mex_Iface::outputCubeCellArray(const CubeField<ElemT> &field)
{
    int nCells = static_cast<int>(field.n_elem);
    mxArray* arr = mxCreateCellMatrix(nCells, 1);
    for(int i=0;i<nCells;i++){
