...
savename = fullfile(topdir,[basename 'results']);
%% Mask the Cell Fill
...
[~ ,threshval_g,~]= GeneralAnalysis.imgThreshold_fixedUserInput(cellfill_g(:,:,ceil(numslices)-1)); %user select - change the '1' to select which frame to choose bg from
...
joinchannels('rgb',tag1.mask,tag2.mask)
